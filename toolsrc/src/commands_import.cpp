...
namespace vcpkg::Commands::Import
{
    ...
    {
        Files::check_is_directory(__LINE_INFO__, path);
    ...
    {
        Files::check_is_directory(__LINE_INFO__, include_directory);
        Files::check_is_directory(__LINE_INFO__, project_directory);
        Files::check_is_directory(__LINE_INFO__, destination_path);
    ...
    void perform_and_exit(const vcpkg_cmd_arguments& args, const vcpkg_paths& paths)
    {
        ...
        Checks::check_exit(__LINE_INFO__, pghs.size() == 1, "Invalid control file %s for package", control_file_path.generic_string());
