...
namespace vcpkg
{
    ...
    {
        Checks::check_exit(__LINE_INFO__, !this->m_isRunning, "This stopwatch is already running.");
    ...
    const Stopwatch& Stopwatch::stop()
    {
        ...
        Checks::check_exit(__LINE_INFO__, this->m_isRunning, "This stopwatch is already stopped.");
